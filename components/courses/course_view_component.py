...
class CourseViewComponent(BaseComponent):
    ...
    def check_visible(self, index: int, title: str, max_score: str, min_score: str, estimated_time: str):
        ...
        self.max_score_text.check_have_text(f"Max score: {max_score}", index)
        self.min_score_text.check_visible(index)
        self.min_score_text.check_have_text(f"Min score: {min_score}", index)

        self.estimated_time_text.check_visible(index)
        self.estimated_time_text.check_have_text(f"Estimated time: {estimated_time}", index)
